...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    //const aa = {quoted: m, userJid: conn.user.jid};
    //const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: '𝘼𝙡𝙘𝙖𝙗𝙤𝙩 𝙫.1', body: null, thumbnail: imagen1, sourceUrl: 'www.instagram.com/alcashop.ff'}, mentionedJid: [m.sender]}}}, aa);
    //await conn.relayMessage(m.chat, prep.message, {messageId: prep.key.id, mentions: [m.sender]});
