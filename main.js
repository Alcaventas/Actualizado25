...
while (true) {
numeroTelefono = await question(chalk.bgBlack(chalk.bold.redBright('🟢 Ingresa el número que sera bot\nPor ejemplo: +59178862672\n')))
...
rl.close()  
        ...
        setTimeout(async () => {
            ...
            console.log(chalk.yellow('✅️ Introduce el código de emparejamiento en WhatsApp.'));
...
global.reloadHandler = async function(restatConn) {
 ...
 conn.welcome = '`*╭┈⊰* @subject *⊰┈ ✦*\n*┊✨ BIENVENIDO(A)!!*\n┊💖 @user\n┊📄 *LEA LA DESCRIPCIÓN DEL GRUPO*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*\n${String.fromCharCode(8206).repeat(850)}\n@desc`}
  ...
  conn.sSubject = '𝘼𝙡𝙘𝙖𝙗𝙤𝙩 𝙫.1 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙀𝙇 𝙉𝙐𝙀𝙑𝙊 𝙉𝙊𝙈𝘽𝙍𝙀 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙀𝙎:*\n\n@subject'}
  conn.sIcon = '𝘼𝙡𝙘𝙖𝙗𝙤𝙩 𝙫.1 𝑸𝑼𝑬 𝙎𝙀 𝙃𝘼 𝘾𝘼𝙈𝘽𝙄𝘼𝘿𝙊 𝙇𝘼 𝙁𝙊𝙏𝙊 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊!!*'}
  conn.sRevoke = '𝘼𝙡𝙘𝙖𝙗𝙤𝙩 𝙫.1 𝑸𝑼𝑬 𝘼𝙃𝙊𝙍𝘼 𝙀𝙎𝙏𝙀 𝙀𝙎 𝙀𝙇 𝙉𝙐𝙀𝙑𝙊 𝙀𝙉𝙇𝘼𝘾𝙀 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊!!*\n\n*@revoke*'}
